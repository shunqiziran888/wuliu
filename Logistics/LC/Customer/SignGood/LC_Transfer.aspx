<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Transfer.aspx.cs" Inherits="Logistics.LC.Customer.SignGood.LC_Transfer" %>
          ...
          <div class="content" style="background:#ededed;">
            <div class="page-index">
              <div class="cgfh-main">
                ...
                <a href="/LC/Customer/SignGood/LC_IndexSG.aspx">我知道了</a>
              </div>
            </div>
          </div>
        </div>
