    ...
    <div class="page-group">
        <div class="page page-current">
            ...
            <header class="bar bar-nav">
                <a href="/LC/Customer/TrackGood/LC_IndexTK.aspx" class="icon iconfont icon-zuo pull-left"></a>
                <h1 class="title">发出货物详情</h1>
            </header>
                ...
                <div class="page-index">
                    ...
                    <div style="padding:1.5rem 1rem;position: relative;" class="white mart_10">
                        ...
                        <ul>
                            ...
                            <%if (v.State == 10)
                                 { %>
                            <li class="dis_flex jus_bet ali_center marb_10" id="chexiao">
                                <i class="fz_12 col_10 dis_flex jus_center">
                                    <span class="fz_12 dis_block" style="border:1px solid;width: 20px;height: 20px;line-height: 20px;text-align: center;border-radius: 20px;">2</span>
                                </i>
                                <div class="col_90" style="margin-left:10px;">
                                    <span class="fz_12">发货撤销：</span>
                                    <span class="fz_12" style="margin-left:10px;"><%=v.RevokeTime %></span>
                                </div>
                            </li>
                            <%} %>
                             <%if (v.State == 20)
