                    ...
                    <div class="check_box row_44 white pos_r">
                        ...
                        <div class="check_main check_main_left pos_a col_100 white bor_top  dis_none" style="top:2.2rem; z-index:2;">
                            ...
                            <div class="dis_flex jus_aro bor_bottom" style="padding:.5rem;">
                                ...
                                <input class="gray col_30" type="date" placeholder="2017.07.12" value="2017-08-31"> <input class="close_btn  col_25"
                                    type="button" style="color:#5986de; border:1px solid #5986de;padding: 0;" value="确定">
                            </div>
                        </div>
                        ...
                        <li class="zbsh-li">
                            <a href="#">
                                <div class="col-100">
                                  ...
                                  <p class="zbsh-hh fc_ash col_50 fz_16">收货人： <span class="fz_14"><%=v.Consignor %></span></p>
                                  ...
                                  <p class="zbsh-hh fc_ash col_50 fz_16">代收款： <span class="fz_14"><%=v.GReceivables %></span></p>
                                    ...
                                    <p class="fz_16 dis_flex jus_bet ali_center fc_red" style="padding:0 10%;"><i>合计金额： <span>123</span></i><i class="fz_12 fc_ash">暂时不显示（合计）</i></p>
                                </div>
                            </a>
                        </li>
                        <%} %>
