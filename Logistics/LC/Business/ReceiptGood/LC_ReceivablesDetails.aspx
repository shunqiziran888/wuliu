<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_ReceivablesDetails.aspx.cs" Inherits="Logistics.LC.Business.ReceiptGood.LC_ReceivablesDetails" %>
...
<script type="text/javascript">
    ...
    function success()
    {
        ...
        var OIDDetaila = "<%=OIDDetaila%>";
        var ssnumber = "<%=ssnumber%>";
        var FreightDetail = "<%=FreightDetail%>";
        var OtherExpenses = "<%=OtherExpenses%>";
        var Ends = "<%=Ends%>";
        var BindLogisticsUid = "<%=BindLogisticsUid%>";
        if (yunfei != "" && yunfei != undefined)
        {
            window.location.href = "/LC/Business/ReceiptGood/LC_Success.aspx?OIDDetaila=" + OIDDetaila + "&ssnumber=" + ssnumber + "&FreightDetail=" + yunfei + "&OtherExpenses=" + OtherExpenses + "&Ends=" + Ends + "&BindLogisticsUid=" + BindLogisticsUid;
        }
        else
        {
            window.location.href = "/LC/Business/ReceiptGood/LC_Success.aspx?OIDDetaila=" + OIDDetaila + "&ssnumber=" + ssnumber + "&FreightDetail=" + FreightDetail + "&OtherExpenses=" + OtherExpenses + "&Ends=" + Ends + "&BindLogisticsUid=" + BindLogisticsUid;
        }
    }
</script>
