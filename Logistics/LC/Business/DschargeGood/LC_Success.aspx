<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Success.aspx.cs" Inherits="Logistics.LC.Business.DschargeGood.LC_Success" %>
          ...
          <div class="content" style="background:#ededed;">
            <div class="page-index">
              <div class="cgfh-main">
                ...
                <a href="/LC/Business/DschargeGood/IndexDhg.aspx">我知道了</a>
              </div>
            </div>
          </div>
        </div>
