<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Receivables.aspx.cs" Inherits="Logistics.LC.Business.DschargeGood.LC_Receivables" %>
...
<script type="text/javascript">
    ...
    function success()
    {
        ...
        {
            window.location.href = "/LC/Business/DschargeGood/LC_Success.aspx?OID=" + OID + "&SSyf=" + SSyf + "&SSdsk=" + SSdsk + "&SStf=" + SStf + "&SShj=" + confirmTotal;
        }
        else
        {
