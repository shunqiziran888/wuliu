    ...
    <div class="page-group">
        <div class="page page-current">
            ...
            <header class="bar bar-nav">
                <a href="/LC/Business/PretendCar/LC_Vehicle.aspx" class="icon iconfont icon-zuo pull-left"></a>
                <!-- <p class="add_wuliu">
...
<body>
    ...
    <script>
        ...
        //    window.location.href = "/LC/Business/PretendCar/LC_IndexPC.aspx";
        //}, 2000)
        Href("/LC/Business/PretendCar/LC_IndexPC.aspx",200);
    </script>
