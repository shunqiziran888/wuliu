            ...
            <body>
                <div class="page-group">
                    ...
                    <i class="add_txt">历史记录</i>
                            ...
                            <a href="/LC/Business/MeetCar/LC_Success.aspx?CH=<%=list.GetIndexValue(0).VehicleID%>&Start=<%=list.GetIndexValue(0).Initially %>&End=<%=list.GetIndexValue(0).Destination %>"
                                class="icon pull-right dis_inline" style="background:#009621;color:#fff;border:1px solid #bbb; line-height:1.5rem; padding:0 1rem;margin-top:.28rem;">下一步</a>
                        ...
                        <div class="search-input">
                            ...
                            <input type="search" id='search' placeholder='搜索订单' />
                                ...
                                <div class="white mart_20" style="padding:1rem;line-height:1.5rem;">
                                    ...
                                    <p class="dis_flex fz_14 jus_bet fc_ash">
                                        <i class="col_50"><span class="col_30">现付：</span> <span class="col_70"><%=Math.Round(xianfu.ConvertData<decimal>(),2)%>元</span></i>
                                        <i class="col_50"><span class="col_30">提付：</span> <span class="col_70"><%=Math.Round(tifu.ConvertData<decimal>(),2)%>元</span></i>
                                        
                                    </p>
                                        <p class="dis_flex fz_14 jus_bet fc_ash">
                                        
                                        <i class="col_50"><span class="col_30">扣付：</span> <span class="col_70"><%=Math.Round(koufu.ConvertData<decimal>(),2)%>元</span></i>
                                        <i class="col_50">
                            ...
                            <div class="col_80">
                                ...
                                <p class="fz_14 dis_flex jus_bet"><i>运费：<span><%=Math.Round(v.Freight.ConvertData<decimal>(),2) %></span></i><i>代收款：<span><%=Math.Round(v.GReceivables.ConvertData<decimal>(),2) %></span></i></p>
                                <p class="fz_14"><i>货号：<span><%=v.GoodNo %></span></i><i class="fz_12" style="margin-left:1rem;"><%=v.TruckTime %></i></p>
                            </div>
                            </div>
                        </label>
                                        <%} %>
