<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Index.aspx.cs" Inherits="Logistics.LC.Business.GoodPayment.Paid.LC_Index" %>
    ...
    <div class="page-group">
        <div class="page page-current">
            ...
            <header class="bar bar-nav">
                ...
                <a href="/LC/Business/GoodPayment/Paid/LC_Receivables.aspx" class="icon pull-right dis_inline  green" style="color:#fff;border:1px solid #bbb; line-height:1.5rem; padding:0 1rem;margin-top:.28rem;">下一步</a>
            ...
            <div class="content" style="background:#f2f2f2;">
                <div class="page-index">
                    ...
                    <div class="zongji mart_10">
                        ...
                        <p class="zongji_top dis_flex  marb_10">
                            <i class="col_50 fz_16">微信收款： <span class="fz_14">1201.1</span></i>
                            <i class="col_50 fz_16">现金收款： <span class="fz_14">1201.1</span></i>
                        </p>
                        <p class="zongji_top dis_flex">
                            <i class="col_50 fz_16">支付宝： <span class="fz_14">1201.1</span></i>
                            <i class="col_50 fz_16">银行卡： <span class="fz_14">1201.1</span></i>
                        </p>
                        
                    </div>
                    <ul class="zbsh-tab1">

                        <li class="zbsh-li" style="padding:.5rem 10%;">
                            <a href="#">
                                <div class="col_100">
                                    <i class="zbsh-xd2">
                                  <p class="zbsh-zffs fz_14">货号： <span class="huo_name fc_ash fz_14">xxxx222</span></p>
                                    </i>
                                    <i class="zbsh-xd2">
                                  <p class="zbsh-zffs fz_14">货物名： <span class="huo_name fc_ash fz_14">一大箱可口可乐 <i class="huo_num">x12</i></span>
                                    <span class="huo_fnagshi">(现付)</span></p>
                                    </i>
                                    <i class="zbsh-xd1">
                                  <p class="zbsh-shr col_50 fz_14">发货人： <span class="ft_color_ash fz_14">司马相如</span></p>
                                  <p class="zbsh-hh fc_ash col_50 fz_14">收货人： <span class="fz_14">包大人</span></p>
                                  
                                </i>
                                    <i class="zbsh-xd1">
                                  <p class="zbsh-shr col_50 fz_14">运费： <span class="ft_color_ash fz_14">3010</span></p>
                                  <p class="zbsh-hh fc_ash col_50 fz_14">代收款： <span class="fz_14">1899</span></p>
                                  
                                </i>
                                    <p class="fz_16 dis_flex ali_center" style="justify-content:flex-end;">
                                        <i class="fz_12 fc_ash">2016年-12月-23日 09：21</i></p>
                                </div>
