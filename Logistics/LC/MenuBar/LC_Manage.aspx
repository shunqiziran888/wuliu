<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Manage.aspx.cs" Inherits="Logistics.LC.MenuBar.LC_Manage" %>
                    ...
                    <ul class="zbshangjia-ul">
                        ...
                        <li class="shangjia-li3">
                            <a href="fengongsi.html" class="row">
                                <div class="col-30 shangjia-left">
                                    <span class="iconfont icon-beenhere" style="color: #009621;"></span>
                                </div>
                                <div class="col-50 shangjia-center">
                                    授权管理
                                </div>
