    ...
    <div class="page-group">
        <div class="page page-current">
            ...
            <div class="content" style="background:#ededed;">
                <div>
                    <div><img src="/GetQR.aspx?url=<%=HttpUtility.UrlEncode($"http://192.168.0.200/Login/Register.aspx?ZType=4&UID={UID}") %>&logo=http://wl.mikiboss.com/Style/img/success.png"/></div>
