<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LC_Line.aspx.cs" Inherits="Logistics.LC.LC_Line" %>
        ...
        <div class="page page-current">
            ...
            <div class="content" style="background:#ededed;">
                <div class="page-index">
                    <div class="top-btn">
                        <a href="/LC/Manage/Line/LC_LineAdd.aspx" class="row external"><span class="iconfont icon-jiahao"></span> 新增线路</a>
                    </div>
                    <!-- <div class="searchbar">
                        ...
                        <!-- <p>近期发货列表</p> -->
                         <%
                                    foreach(var v in list)
                                    {
                                     ...
                                     %>
                        <li class="dingdan-li">
                            <a href="/LC/Manage/Line/LC_LineDetails.aspx?ID=<%=v.ID %>" class="row external">
