...
namespace Logistics.ApiCommand
{
    ...
    /// 收欠款详情
    /// </summary>
    [SuperCommand.Attribute.Doc(typeof(CMD_GetCollectDebtsDetail), "收欠款详情")]
    ...
    public class CMD_GetCollectDebtsDetail : WebCommandBase, SuperCommand.ICommandBase<WebCommandVOBase>
    {
        public TCommandState ExeCommand<TCommandState>(WebCommandVOBase command) where TCommandState : CommandState, new()
        {
            (bool, string, object) vo = BLL.BLL.LC_Customer.GetCollectDebtsDetail(web);
